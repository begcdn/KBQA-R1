...
# Optimized configuration for KBQA workloads
...
def start(dbPath, port):
  ...
  config = (
    ...
    f"MaxQueryCostEstimationTime = 20\n"
    f"MaxQueryExecutionTime = 20\n"
    f"\n"
    f"[HTTPServer]\n"
