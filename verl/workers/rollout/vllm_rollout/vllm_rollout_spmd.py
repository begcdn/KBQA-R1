...
class vLLMRollout(BaseRollout):
    def __init__(
        ...
        # DEBUG: Log calculate_log_probs configuration
        logger.warning(f"[VLLM ROLLOUT CONFIG] calculate_log_probs = {self.config.calculate_log_probs}")
        logger.warning(f"[VLLM ROLLOUT CONFIG] response_length = {self.config.response_length}")
        logger.warning(f"[VLLM ROLLOUT CONFIG] sampling_params.logprobs = {self.sampling_params.logprobs}")
