...
PPO_RAY_RUNTIME_ENV = {
    "env_vars": {
        ...
        "NCCL_CUMEM_ENABLE": "0",
        # Enable Ray debugging for better error tracing
        # "RAY_DEBUG": "1",
...
def get_ppo_ray_runtime_env():
    ...
    # Define critical env vars that should always be in runtime_env, even if set in system env
    critical_vars = {"RAY_DEBUG", "RAY_DEBUG_POST_MORTEM"}
    
    for key in list(runtime_env["env_vars"].keys()):
        # Skip removal for critical debugging variables
